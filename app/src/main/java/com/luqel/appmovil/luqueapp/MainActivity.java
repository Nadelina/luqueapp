...
public class MainActivity extends AppCompatActivity {
    ...
    */
        ...
        /*ImageView logop = (ImageView)findViewById(R.id.logop);
        Button btn_verlibros = (Button)findViewById(R.id.btn_verlibros);

        btn_verlibros.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intento = new Intent(getApplicationContext(),VerLibros.class);
